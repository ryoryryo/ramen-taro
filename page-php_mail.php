        ...
        <div class="inquiry__wrapper">
            ...
            <div class="inquiry-form__wrapper wrapper">
                ...
                <?php if ($error['send-fail'] === 'fail') : ?>
                    <button class="send-fail-message" type="button" aria-label="close modal window">
                        <span>メールの送信に失敗しました</span>
                        <span>(>_<)</span>
                    </button>
                <?php endif; ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // フォームの送信ボタンの効果を１回きりにして２重送信防止
        document.querySelector('form').addEventListener('submit', function() {
            this.querySelector('button[type="submit"]').disabled = true;
        });
        // エラーメッセ―ジをクリックで消せるようにする
        const failMessage = document.querySelector('.send-fail-message');
        failMessage.addEventListener('click', function() {
