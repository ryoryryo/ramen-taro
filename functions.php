...
function enqueueStyles()
{
    ...
    // shop, shop_detail または inquiry ページ、または、php_mailページまたはその親ページ
...
function enqueueScripts()
{
    ...
    if (is_front_page() || is_page('home') || is_page('about_us') || $parent_id == get_page_by_path('home')->ID || $parent_id == get_page_by_path('about_us')->ID) {
    ...
    wp_enqueue_script('animation-script', get_template_directory_uri() . '/script/animation.js', array('gsap', 'gsap-ScrollTrigger'), null, true);
    }
